  ...
  const experiences = [
    {
      ...
      period: "2022 - Present",
      description: "Led cross-functional teams in analyzing business requirements and developing strategic solutions. Implemented data-driven approaches that increased operational efficiency by 25%."
    },
    {
      ...
      >
        ...
        >
          ...
          <p className="text-textSecondary max-w-3xl mx-auto">
            My journey through the corporate landscape has equipped me with diverse skills and insights.
          </p>
        </motion.div>
